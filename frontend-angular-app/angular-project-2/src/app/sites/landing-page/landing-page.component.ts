...
export class LandingPageComponent implements OnInit {
  ...
  fillDatabase() {
    //this.countryService.create(ELEMENT_DATA[0]).subscribe(answer => console.log(answer))
    ELEMENT_DATA.forEach(country => this.countryService.create(country).subscribe())
  }
